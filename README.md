# video-generation-character

An OpenCode plugin created by Gemini CLI
...
```json
{
  "plugins": ["video-generation-character"]
}
```
...
https://github.com/example/video-generation-character
